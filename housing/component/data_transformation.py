...
from housing.config.configuration import Configuartion,DataTransformationConfig
...
class DataTransformation:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        try:
            ...
            logging.info(f"Applying preprocessing object on training and test daatframes")
            ...
            train_file_name = os.path.dirname(train_file_path).replace(".csv", ".npz")
            test_file_name = os.path.dirname(test_file_path).replace(".csv", ".npz")
            ...
            save_numpy_array_data(file_path=transformed_test_file_path, array=train_arr)
